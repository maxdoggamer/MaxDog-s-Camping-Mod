...
package net.mcreator.maxdogscampingmod.world.inventory;
...
public class TentBoxGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public TentBoxGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(MaxdogsCampingModModMenus.TENT_BOX_GUI.get(), id);
